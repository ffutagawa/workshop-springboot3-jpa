package com.ffutagawa.courseSpringNelioAlves.config;
...
import com.ffutagawa.courseSpringNelioAlves.entities.Payment;
import com.ffutagawa.courseSpringNelioAlves.entities.Product;
import com.ffutagawa.courseSpringNelioAlves.entities.User;
import com.ffutagawa.courseSpringNelioAlves.entities.enums.OrderStatus;
import com.ffutagawa.courseSpringNelioAlves.repositories.CategoryRepository;
import com.ffutagawa.courseSpringNelioAlves.repositories.OrderItemRepository;
import com.ffutagawa.courseSpringNelioAlves.repositories.OrderRepository;
import com.ffutagawa.courseSpringNelioAlves.repositories.ProductRepository;
import com.ffutagawa.courseSpringNelioAlves.repositories.UserRepository;

@Configuration
@Profile("test")
public class TestConfig implements CommandLineRunner { // é executado assim que a aplicação for iniciada
